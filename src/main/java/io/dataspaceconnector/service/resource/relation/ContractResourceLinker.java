...
@Service
@NoArgsConstructor
public class ContractResourceLinker extends NonOwningRelationService<Contract, Resource,
        ContractService, ResourceService> {

    @Override
    protected final List<Resource> getInternal(final Contract owner) {
