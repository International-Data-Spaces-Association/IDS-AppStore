...
/**
 * Handles the relation between broker and resources.
 */
@Service
@NoArgsConstructor
public class BrokerResourceLinker extends OwningRelationService<Broker, Resource, BrokerService,
        ResourceService> {

    @Override
    protected final List<Resource> getInternal(final Broker owner) {
