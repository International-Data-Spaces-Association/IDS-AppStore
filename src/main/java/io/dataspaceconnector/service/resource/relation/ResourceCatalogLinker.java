...
/**
 * Handles the relation between resources and catalogs.
 */
@Service
@NoArgsConstructor
public class ResourceCatalogLinker extends NonOwningRelationService<Resource, Catalog,
        ResourceService, CatalogService> {

    @Override
    protected final List<Catalog> getInternal(final Resource owner) {
