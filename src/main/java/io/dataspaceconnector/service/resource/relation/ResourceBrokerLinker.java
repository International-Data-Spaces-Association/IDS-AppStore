...
@Service
@NoArgsConstructor
public class ResourceBrokerLinker extends OwningRelationService<Resource, Broker, ResourceService,
        BrokerService> {

    @Override
    protected final List<Broker> getInternal(final Resource owner) {
