...
/**
 * Handles the relation between a catalog and its resources.
 */
@Service
@NoArgsConstructor
public class CatalogResourceLinker extends OwningRelationService<Catalog, Resource,
     ...
     */
    @Override
    protected List<Resource> getInternal(final Catalog owner) {
