...
/**
 * Offers the endpoints for managing the relations between resources and representations.
 */
@RestController
@RequestMapping(BasePath.RESOURCES + "/{id}/" + BaseType.REPRESENTATIONS)
@Tag(name = ResourceName.RESOURCES, description = ResourceDescription.RESOURCES)
public class ResourcesToRepresentationsController extends BaseResourceChildController<
        ResourceRepresentationLinker, Representation, RepresentationView> {
}
