...
/**
 * Offers the endpoints for managing the relations between resources and subscriptions.
 */
@RestController
@RequestMapping(BasePath.RESOURCES + "/{id}/" + BaseType.SUBSCRIPTIONS)
@Tag(name = ResourceName.RESOURCES, description = ResourceDescription.RESOURCES)
public class ResourcesToSubscriptionsController extends BaseResourceChildRestrictedController<
        ResourceSubscriptionLinker, Subscription, SubscriptionView> {
}
