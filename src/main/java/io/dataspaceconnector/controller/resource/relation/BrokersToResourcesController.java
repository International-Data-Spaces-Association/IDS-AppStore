...
/**
 * Offers the endpoints for managing the relations between broker and resources.
 */
@RestController
@RequestMapping(BasePath.BROKERS + "/{id}/" + BaseType.RESOURCES)
@Tag(name = ResourceName.BROKERS, description = ResourceDescription.BROKERS)
public class BrokersToResourcesController extends BaseResourceChildRestrictedController<
        BrokerResourceLinker, Resource, ResourceView> {
}
