...
/**
 * Offers the endpoints for managing the relations between catalogs and resources.
 */
@RestController
@RequestMapping(BasePath.CATALOGS + "/{id}/" + BaseType.RESOURCES)
@Tag(name = ResourceName.CATALOGS, description = ResourceDescription.CATALOGS)
public class CatalogsToResourcesController extends BaseResourceChildController<
        CatalogResourceLinker, Resource, ResourceView> {
}
