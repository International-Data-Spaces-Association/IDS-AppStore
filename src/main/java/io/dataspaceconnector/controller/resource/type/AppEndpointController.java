...
//public class AppEndpointController implements CRUDController<AppEndpoint, AppEndpointDesc, Object> {
//
//    /**
...
//     * Service for generic endpoint.
//     */
//    private final @NonNull AppEndpointService service;
//
//
////    /**
...
//     */
//    private final @NonNull PagedResourcesAssembler<AppEndpoint> pagedAssembler;
//
//    /**
//     * Assembler for the EndpointView.
//     */
//    private final @NonNull AppEndpointViewAssembler assemblerProxy;
//
//    /**
...
//     */
//    private ResponseEntity<Object> respondCreated(final AppEndpoint obj) {
...
//     */
//    @Override
//    public ResponseEntity<Object> create(AppEndpointDesc desc) {
//        return respondCreated(service.create(desc));
//    }
//
//    /**
...
//     */
//    @Override
//    public ResponseEntity<Object> update(UUID resourceId, AppEndpointDesc desc) {
...
////     */
////    @Override
////    public ResponseEntity<Object> update(final UUID resourceId, final AppEndpointDesc desc) {
//////        if (isAppEndpoint(desc)) {
//////            throw new MethodNotAllowed();
//////        }
////        final var resource = service.update(resourceId, desc);
