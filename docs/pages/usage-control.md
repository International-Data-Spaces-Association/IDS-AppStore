...
It is possible to enforce certain high-level usage control policies at the data transfer level of a connector. For a better overview of the policies that can be enforced at the route level, a look can be taken at the table at the end of this chapter. 
...
## <a name="ucapp"> Usage Control Awareness with Data Apps using the Usage Control App <br> (HTTP-REST Integration) </a>
...
This specific integration and the active sending of the hooks to the Usage Control App results in a Data App being assigned to the [advanced profile](./types-and-profiles/profiles).

![PIP_PEP Integration](./assets/images/uc_pip_pep.png)

## <a name="in-app-ucf"> Usage Control Awareness with Data Apps using an Usage Control <br> Framework (In-App Implementation)</a>
...
### <a name="ucpo1"> Allow the usage of data </a>
...
### <a name="ucpo2"> Connector-restricted data usage (route restricted data usage) </a>
...
### <a name="ucpo3"> Application-restricted data usage </a>
...
### <a name="ucpo4"> Interval-restricted data usage </a>
...
### <a name="ucpo5"> Duration-restricted data usage </a>
...
### <a name="ucpo6"> Location-restricted data usage </a>
...
### <a name="ucpo7"> Purpose-restricted data usage </a>
...
### <a name="ucpo8"> Event-restricted data usage </a>
The data usage is allowed for the timespan of a realworld event.

### <a name="ucpo9"> Use the data not more than N times </a>
...
### <a name="ucpo10"> Allow use of data and delete it after </a>
...
### <a name="ucpo11"> Modify data (in transit) </a>
...
### <a name="ucpo12"> Log the data usage information </a>
...
### <a name="ucpo13"> Notify a party or a specific group of users when the data is used </a>
...
### <a name="ucpo14"> Attach Policy when distribute to a third-party (connector or route layer) </a>
...
### <a name="ucpo15"> Distribute only if encrypted (app, route layer) </a>
...
### <a name="ucpo16"> Restrict the data usage to specific state (connector) </a>
